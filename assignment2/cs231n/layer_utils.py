...
# This is a single function to calculate forward pass, activation 
# and normalization also if mentioned.
def affine_norm_relu_forward(x, w, b, gamma, beta, bn_param=None,normalization=None, use_dropout=None, dropout_param=None):
